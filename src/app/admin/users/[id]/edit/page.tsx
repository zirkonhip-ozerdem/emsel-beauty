    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <div className="rounded-xl border bg-white p-6 shadow-sm">
        <section className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <input name="firstName" value={form.firstName} onChange={handleInput} className={inputClass} />
          <input name="lastName" value={form.lastName} onChange={handleInput} className={inputClass} />
